...
## 2019-05-02-Week13
### HW4~6:PCA
* [練習](https://github.com/j88620714/DataScience/blob/master/HW4-6/practice.ipynb):這次的作業比較偏向文字處理，而我們先前的資料都以數值居多，因此我們到台北市開放平台上找到了"107年度A1及A2類交通事故明細"來做為我們的文本，並試圖分析事故間的關聯性。
